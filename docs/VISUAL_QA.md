...
- [ ] Home `/`: split hero — copy left, native SVG diagram right; no poster/URL/debug labels in diagram
- [ ] `hero.image_alt` matches six nodes (Input, Context, Reasoning, Quality, Output, Workflow)
