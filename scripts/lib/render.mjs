...
function loadFont(name, weight, style) {
  ...
  if (!existsSync(path)) {
    throw new Error(`Missing font: ${path}. Run: npm run fonts:fetch`);
  }
  return {
    name: 'Inter',
...
/** Global font options — stable reference for Satori font cache (vercel/satori#590). */
...
/**
 * Render JSX tree to PNG buffer via Satori + resvg.
